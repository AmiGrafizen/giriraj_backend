...
console.log('Loaded MONGODB_URI:', process.env.MT_MONGODB_URI);
...
const MTConnection = mongoose.createConnection(process.env.MT_MONGODB_URI, {
...
for (const file of files) {
  if (file.endsWith('.model.js')) {
    ...
    const modelName = `MT${pascalCaseName}`;

    // Register model
    models[modelName] = MTConnection.model(modelName, schema);
    console.log(`✅MT Loaded model: ${modelName}`);
  }
}

// Export the connection and all models
export { MTConnection, models as mtModels };
